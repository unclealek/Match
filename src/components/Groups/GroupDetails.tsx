      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-4">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-secondary bg-primary hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
          >
            Back to Groups
          </button>
        </div>
